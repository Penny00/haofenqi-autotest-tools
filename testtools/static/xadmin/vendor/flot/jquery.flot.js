...
(function($) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                xaxis: {
                    ...
                    color: null, // autotest color, labels, ticks
        ...
        function setupCanvases() {
            ...
            placeholder.css("padding", 0) // padding messes up the positioning
                .children(":not(.flot-autotest,.flot-overlay)").remove();

            if (placeholder.css("position") == 'static')
                placeholder.css("position", "relative"); // for positioning labels and overlay

            surface = new Canvas("flot-autotest", placeholder);
        ...
        function setupTickGeneration(axis) {
            ...
            // Flot supports autotest-10 axes; any other mode else is handled by a plug-in,
            // like flot.time.js.
    ...
    // round to nearby lower multiple of autotest
